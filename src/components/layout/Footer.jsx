  ...
  return (
    <footer className="site-footer">
      <div className="container footer-grid">
        <div className="footer-brand"><Link className="footer-logo" to="/" aria-label="Business Financial One home"><img src={business.logoUrl} alt="Business Financial One" /></Link><p>Investor-focused real estate and business financing solutions structured around real opportunities.</p><div className="socials socials--footer"><a href={business.social.facebook} target="_blank" rel="noreferrer" aria-label="Facebook">f</a><a href={business.social.youtube} target="_blank" rel="noreferrer" aria-label="YouTube">▶</a><a href={business.social.x} target="_blank" rel="noreferrer" aria-label="X / Twitter">X</a><a href={business.social.instagram} target="_blank" rel="noreferrer" aria-label="Instagram">◎</a><a href={business.social.linkedin} target="_blank" rel="noreferrer" aria-label="LinkedIn">in</a></div></div>
